...
import { c as createCommonjsModule, a as commonjsGlobal } from './_commonjsHelpers-1acf89e0.js';
...
function (_ContentSwitcher) {
  ...
  function Tab(element, options) {
    ...
    _this = _possibleConstructorReturn$7(this, _getPrototypeOf$7(Tab).call(this, element, options));
  ...
  _createClass$7(Tab, [{
    ...
    value: function _changeState(detail, callback) {
      ...
      _get$1(_getPrototypeOf$7(Tab.prototype), "_changeState", this).call(this, detail, function (error) {
        if (!error) {
    ...
    value: function _handleClick(event) {
      ...
      if (button && !button.classList.contains(this.options.classButtonDisabled)) {
        _get$1(_getPrototypeOf$7(Tab.prototype), "_handleClick", this).call(this, event);
...
function (_mixin) {
  ...
  _createClass$a(FloatingMenu, [{
      ...
      if (state === 'shown') {
        ...
        if (!this.element.hasAttribute(this.options.attribAvoidFocusOnOpen)) {
          ...
          if (primaryFocusNode) {
            ...
            if ("development" !== "production") {
              var elementTabindex = this.element.getAttribute('tabindex');
              "development" !== "production" ? browser(elementTabindex !== null && parseInt(elementTabindex, 10) > -1, 'Floating Menus without interactive elements must include tabindex="0" on the floating element.') : void 0;
            }
          }
        }
      }
    ...
    value: function release() {
      ...
      _get$2(_getPrototypeOf$a(FloatingMenu.prototype), "release", this).call(this);
    }
  }]);
    ...
    value: function _changeState(state, detail, callback) {
      ...
      var transitionEnd = function transitionEnd() {
        ...
        if (state === 'shown' && _this2.element.offsetWidth > 0 && _this2.element.offsetHeight > 0) {
          ...
          if ("development" !== "production") {
            "development" !== "production" ? browser(focusableItem, "Modals need to contain a focusable element by either using " + "`".concat(_this2.options.selectorPrimaryFocus, "` or settings.selectorTabbable.")) : void 0;
          }
        }
    ...
    _this.refreshRows = function () {
      ...
      if (_this.parentRows.length > 0) {
        ...
        if (newExpandableRows.length > 0) {
          ...
          var mergedExpandableRows = [].concat(_toConsumableArray$3(toArray$4(_this.expandableRows)), _toConsumableArray$3(toArray$4(diffExpandableRows)));
...
function (_mixin) {
  ...
  _createClass$j(DatePicker, [{
    ...
    value: function release() {
      ...
      return _get$3(_getPrototypeOf$j(DatePicker.prototype), "release", this).call(this);
    }
    /**
     * The component options.
     * If `options` is specified in the constructor,
...
function (_mixin) {
  ...
  _createClass$u(Tile, [{
    key: "release",
    value: function release() {
      _get$4(_getPrototypeOf$v(Tile.prototype), "release", this).call(this);
    }
    /**
...
function (_NavigationMenuPanel) {
  _inherits$C(NavigationMenu, _NavigationMenuPanel);
  /**
   * A navigation menu
  ...
  function NavigationMenu(element, options) {
    ...
    _classCallCheck$D(this, NavigationMenu);

    _this = _possibleConstructorReturn$C(this, _getPrototypeOf$C(NavigationMenu).call(this, element, options));
    ...
    _this.navigate = function (direction) {
      var items = _toConsumableArray$6(_this.element.querySelectorAll(_this.options.selectorFocusableNavItems));
    ...
    _this._handleClick = function (event) {
      ...
      if (matchesNestedShellNavLink) {
        _toConsumableArray$6(_this.element.querySelectorAll(_this.options.selectorShellNavLinkCurrent)).forEach(function (el) {
  ...
  _createClass$B(NavigationMenu, null, [{
    key: "options",
...
/*#__PURE__*/
function (_NavigationMenuPanel) {
  _inherits$D(ProductSwitcher, _NavigationMenuPanel);
  /**
   * A navigation menu
   * @extends NavigationMenuPanel
   * @param {HTMLElement} element The element working as a selector.
  ...
  function ProductSwitcher(element, options) {
    ...
    _classCallCheck$E(this, ProductSwitcher);

    _this = _possibleConstructorReturn$D(this, _getPrototypeOf$D(ProductSwitcher).call(this, element, options));
    _this.current = '';
  ...
  _createClass$C(ProductSwitcher, [{
    key: "release",
    value: function release() {
      this.triggerButtonIds.clear();
      return _get$5(_getPrototypeOf$D(ProductSwitcher.prototype), "release", this).call(this);
    }
    /**
...
/*#__PURE__*/
function (_mixin) {
  _inherits$E(PaginationNav, _mixin);
  /**
  ...
  function PaginationNav(element, options) {
    ...
    _classCallCheck$F(this, PaginationNav);

    _this = _possibleConstructorReturn$E(this, _getPrototypeOf$E(PaginationNav).call(this, element, options));
  ...
  _createClass$D(PaginationNav, null, [{
    key: "options",
...
const TopbarComponent = class {
    ...
    static get style() { return ".hv-topbar {\n  height: 3rem;\n  border: none;\n  -webkit-box-shadow: 0 0 3px 2px #9f9f9d;\n  box-shadow: 0 0 3px 2px #9f9f9d;\n  background-color: #566369;\n}\n.hv-topbar .bx--header__name {\n  text-align: left;\n  -ms-flex-align: start;\n  align-items: flex-start;\n  -ms-flex-flow: column;\n  flex-flow: column;\n}\n.hv-topbar .hv-label {\n  color: #f9f9f9;\n  font-size: 1rem;\n  font-weight: normal;\n  line-height: 1rem;\n  margin: 0;\n  padding: 0;\n}\n.hv-topbar .hv-creator {\n  color: #f9f9f9;\n  font-size: 0.9rem;\n  font-weight: bold;\n  margin: 0;\n  padding: 0;\n}\n.hv-topbar .hv-logo {\n  max-height: 100%;\n}"; }
};

export { TopbarComponent as hv_topbar };
