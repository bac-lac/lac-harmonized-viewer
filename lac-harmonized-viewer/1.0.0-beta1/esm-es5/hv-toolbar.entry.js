...
var HVToolbar = /** @class */ (function () {
    function HVToolbar(hostRef) {
        registerInstance(this, hostRef);
        this.store = getContext(this, "store");
    }
    HVToolbar.prototype.componentWillLoad = function () {
        this.store.mapDispatchToProps(this, { setPage: setPage });
        this.storeUnsubscribe = this.store.mapStateToProps(this, function (state) {
            var _a = state.document, alternateFormats = _a.alternateFormats, loading = _a.loading, page = _a.page, pageCount = _a.pageCount;
            return {
    ...
    HVToolbar.prototype.componentDidUnload = function () {
        this.storeUnsubscribe();
    };
    HVToolbar.prototype.isFirst = function () {
        return (this.page <= 0);
    };
    HVToolbar.prototype.isLast = function () {
        return (this.page >= (this.pageCount - 1));
    };
    HVToolbar.prototype.handleHomeClick = function () {
        this.setPage(0);
    };
    HVToolbar.prototype.handlePreviousClick = function () {
        this.setPage(this.page - 1);
    };
    HVToolbar.prototype.handleNextClick = function () {
        this.setPage(this.page + 1);
    };
    HVToolbar.prototype.handleFullscreenClick = function () {
        var instance = this.el.closest('.harmonized-viewer');
        if (instance) {
            instance.requestFullscreen();
            instance.classList.add('is-fullscreen');
        }
    };
    HVToolbar.prototype.handleAlternateFormatClick = function () {
    };
    HVToolbar.prototype.handleDropdownClick = function (ev) {
        ev.stopPropagation();
        var target = ev.currentTarget;
        if (target) {
            var dropdown = target.closest('.has-dropdown');
            if (dropdown) {
                dropdown.classList.toggle('is-active');
            }
        }
    };
    HVToolbar.prototype.render = function () {
        var _this = this;
        return (h("nav", { class: "navbar is-light", role: "toolbar", "aria-label": "Toolbar navigation" }, h("div", { class: "navbar-menu" }, h("div", { class: "navbar-start" }, h("a", { class: "navbar-item", title: "Home", onClick: this.handleHomeClick.bind(this) }), h("harmonized-zoom-slider", null), h("div", { class: "navbar-item has-dropdown" }, h("a", { class: "navbar-link" }, "View as"), h("div", { class: "navbar-dropdown" }, h("a", { class: "navbar-item" }, "IIIF"), h("a", { class: "navbar-item" }, "PDF")))), h("div", { class: "navbar-start navbar-center" }, h("a", { class: "navbar-item", title: "Previous", onClick: this.handlePreviousClick.bind(this) }), h("div", { class: "navbar-item toolbar-page" }, h("a", { class: "tag" }, (this.page + 1)), h("span", null, "\u00A0"), h("span", null, "of ", this.pageCount, " pages")), h("a", { class: "navbar-item", title: "Next", onClick: this.handleNextClick.bind(this) })), h("div", { class: "navbar-end" }, h("a", { class: "navbar-item", title: "Fullscreen", onClick: this.handleFullscreenClick.bind(this) }, h("span", { class: "text" }, "Fullscreen")), this.alternateFormats && this.alternateFormats.length > 0 &&
            h("div", { class: "navbar-item has-dropdown" }, h("a", { class: "navbar-link", onClick: this.handleDropdownClick.bind(this) }, h("span", { class: "text" }, "Download")), h("div", { class: "navbar-dropdown is-right" }, this.alternateFormats.map(function (alternateFormat) {
                return (h("a", { class: "navbar-item", onClick: _this.handleAlternateFormatClick.bind(_this) }, h("span", { class: "icon" }), h("span", { class: "text" }, alternateFormat.label)));
            })))))));
    };
    Object.defineProperty(HVToolbar.prototype, "el", {
        get: function () { return getElement(this); },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(HVToolbar, "style", {
