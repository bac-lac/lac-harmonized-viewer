...
const iconLibrary = require('./icon-library-209913d9.js');

var nouislider = iconLibrary.createCommonjsModule(function (module, exports) {
...
const ZoomSliderComponent = class {
    constructor(hostRef) {
        core.registerInstance(this, hostRef);
        this.store = core.getContext(this, "store");
    }
    componentWillLoad() {
        this.store.mapDispatchToProps(this, { setZoomRequest: document$2.setZoomRequest });
