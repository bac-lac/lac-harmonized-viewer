...
export class TopbarComponent {
  ...
  manifestWatchHandler() {
    const title = this.el.querySelector('.hv-title.hv-title--loading');
    if (title) {
      title.classList.remove('hv-title--loading');
    }
  }
    ...
    return (
      <header class="hv-topbar__content" role="banner">
        ...
        <a href="#">
          ...
          <h1 class="hv-title hv-title--loading" innerHTML={this.manifest ? this.manifest.getDefaultLabel() : null}></h1>
        </a>
